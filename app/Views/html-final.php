...
<body>
    ...
    <header>
        ...
        <div class="menu">
            <ul>
                ...
                <li class="menu-item hidden"><a href="/home/excell">Cetak Excell</a>
                </li>
                <li class="menu-item hidden"><a href="/home/html">Cetak HTML</a></li>
                </li>
            </ul>
        </div>
    ...
    <section>
        ...
        <table id="hobi">
            <thead>
                <tr>
                    <th colspan="5">DAFTAR HOBI WITHOUT ROWSPAN</th>
                </tr>
                <tr>
                    <th>No</th>
                    <th>Nama</th>
        ...
        <table id="hobi">
            ...
            <tbody>
                <?php
                $user1 = $this->db->query("SELECT * FROM user")->getResultArray();
